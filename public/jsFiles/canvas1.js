...
const canvasRef= document.getElementById('canvasRef1');
...
bTo1++;
  ...
  var pointAA=[rando()+rando(),rando()+rando()];
  var pointBB=[rando()+rando(),rando()+rando()];
...
ctx.moveTo(pointAA[0], pointAA[1]);
ctx.lineTo(rando(),rando());
ctx.stroke();
//
